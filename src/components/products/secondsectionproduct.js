            ...
            <div className="section-one">
              ...
              <div className="image-container-eight section-one-img">
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/s1.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/s2.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  <ul class="section-one-img-links">
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/s3.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  <ul class="section-one-img-links">
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/s4.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  \
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/s5.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  <ul class="section-one-img-links">
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/s6.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  <ul class="section-one-img-links">
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/s7.jpeg")}
                    alt="img1"
                    width="100%"
                  />
