          ...
          <div className="margin-top">
            ...
            <div className="section-one">
              <a
                ...
                onClick={this.scrollEight.bind(null, -1)}
              >
                <svg
                  width="14.6"
                  height="27"
              ...
              <div className="image-container-nine section-one-img">
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/b1.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/b2.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  <ul class="section-one-img-links">
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/b3.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  <ul class="section-one-img-links">
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/b4.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  <ul class="section-one-img-links">
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/b5.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  <ul class="section-one-img-links">
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/b6.jpeg")}
                    alt="img1"
                    width="100%"
                  />
                  <ul class="section-one-img-links">
                ...
                <div className="section-one-content">
                  <img
                    src={require("../../images/product_page/b7.jpeg")}
                    alt="img1"
                    width="100%"
                  />
